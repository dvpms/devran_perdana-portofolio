  ...
  return (
    <div className="space-y-8 pb-10">
      ...
      >
        <div>
          <h2 className="font-semibold text-foreground">
            {t.projects.wantToSee}
          </h2>
          <p className="text-sm text-muted-foreground">
            {t.projects.hasLiveDemo}
          </p>
        </div>
        <a
      ...
      <div className="mt-12 space-y-10 text-foreground">
          ...
          <div className="flex flex-col gap-5 md:flex-row md:items-start md:justify-between">
            <div className="space-y-2">
              ...
              <h2 className="text-2xl font-bold tracking-tight text-foreground">
                {project.role ?? t.projects.roleDefault}
              </h2>
              <p className="max-w-2xl leading-relaxed text-muted-foreground">
                {t.projects.roleDescription}
              </p>
            </div>
          </div>
        ...
        <ProjectNarrativeSection delay="500ms" number="02" title={t.projects.solutionTitle}>
        ...
        <ProjectNarrativeSection delay="600ms" number="03" title={t.projects.challengesTitle}>
